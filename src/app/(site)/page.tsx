              ...
              <div className="relative mb-12 md:flex items-center md:justify-center">
                ...
                >
                  <div className="p-6 rounded-lg shadow-lg bg-card text-left">
                    ...
                    <h3 className="text-xl font-bold font-headline mt-1 text-foreground">
                      {exp.role}
                    </h3>
...
export default async function HomePage() {
  ...
  const getSkillCategories = (skillsString?: string) => {
    ...
    return skillsString
      ...
      .filter(
        (category): category is { category: string; skills: string[] } =>
          category !== null
      );
  };
      ...
      <FramerMotionWrapper>
        <section className="flex gap-8 pt-12 md:grid-cols-2 md:items-center md:pt-20">
          <div className="">
            ...
            <h2 className="mt-2 text-6xl font-bold tracking-tight text-foreground sm:text-9xl">
              {intro?.headline ?? "Ganesh Tidke"}
            </h2>
            <p className="mt-6 max-w-2xl text-lg font-semibold lg:text-3xl text-gray-600">
              <span className="text-foreground">
                {intro?.role ?? "Software Engineer"}.
              </span>{" "}
              {intro?.subheadline ?? "A self-taught developer..."}
            </p>
      ...
      <FramerMotionWrapper>
        <section className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            I'm currently open for new opportunities. Feel free to get in touch
            and talk more about your projects.
          </p>
