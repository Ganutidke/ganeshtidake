...
import { updateTheme, resetTheme } from '@/lib/actions/theme.actions';
...
export const presets: { name: string; colors: ThemeFormValues }[] = [
  {
    name: 'Default',
    colors: {
...
export const defaultTheme: ThemeFormValues = presets[0].colors;
